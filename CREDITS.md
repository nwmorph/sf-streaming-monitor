...
- [Salesforce Pub/Sub API](https://developer.salesforce.com/docs/platform/pub-sub-api/overview) — gRPC streaming
- [@grpc/grpc-js](https://github.com/grpc/grpc-node) — gRPC client
- [avsc](https://github.com/mtth/avsc) — Avro serialization
- [@salesforce/core](https://github.com/forcedotcom/sfdx-core) — org credential management
